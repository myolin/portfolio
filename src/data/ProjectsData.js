export const iOSProjects = [
  {
    id: 1,
    title: "Taste Chicago",
    description: "TasteChicago is an iOS app written in native Swift which is designed to " + 
  ...
  {
    id: 2,
    title: "Cat And Dog Library",
    description: "The Cat and Dog Library App is a fun and interactive iOS application " +
                 "that allows users to explore, learn about, and engage with a vast " +
...
export const androidProjects = [
  {
    ...
    description: "CTA Bus Tracker is a native Android app written in Java. Stay on schedule with the CTA Bus Tracker app! " +
